...
[task_local]
#联通邮箱签到
2 8 * * * ltmail.js, tag=联通邮箱签到, img-url=https://raw.githubusercontent.com/keepyounger/QuanX/main/Tasks/lt.png, enabled=true

================Loon==============
[Script]
cron "2 8 * * *" script-path=ltmail.js,tag=联通邮箱签到

===============Surge=================
联通邮箱签到 = type=cron,cronexp="2 8 * * *",wake-system=1,timeout=3600,script-path=ltmail.js

============小火箭=========
联通邮箱签到 = type=cron,script-path=ltmail.js, cronexpr="2 8 * * *", timeout=3600, enable=true
 */

const $ = new Env("联通邮箱签到4");
